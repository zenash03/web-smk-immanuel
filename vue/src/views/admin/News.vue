                ...
                <div id="content">
                    ...
                    <div class="container-fluid" id="data">
                        ...
                        <ul class="list list-inline">
                            <li class="d-flex justify-content-between" v-for="n in news" :key="n.id">
                                ...
                                <div class="button">
                                    ...
                                    <router-link :to="`edit-news/${n.id}`" class="btn btn-warning ml-1">Edit</router-link>
                                </div>
                            </li>
                        </ul>
                    <!-- /.container-fluid -->
...
export default {
    ...
    methods: {
        ...
        del(id) {
            axios.delete(`news/${id}?token=${this.token}`)
                .then(res => {
