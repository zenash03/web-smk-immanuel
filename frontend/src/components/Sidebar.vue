  ...
  <aside class="sidebar border-r border-dark-25">
    ...
    <nav class="sidebar-nav text-dark-100 text-base">
      <ul class="menu">
        ...
        <li>
          <router-link to="/dashboard/kartu-pelajar">
        ...
        <li>
          ...
          <ul class="submenu">
            <li>
              <router-link to="/dashboard/event/list"
