            ...
            <div class="grid gap-y-4 col-span-4">
                ...
                <div class="grid grid-flow-col auto-cols-max items-center">
                   ...
                   <div class="block p-6 w-full bg-white rounded-lg border border-gray-200 shadow-md">
                    <p class="font-normal max-h-44 text-ellipsis overflow-auto">Coding is a list of step-by-step instructions that get computers to do what you want them to do. Coding makes it possible for us to create computer software, games, apps and websites. Coders, or programmers, are people who write the programmes behind everything we see and do on a computerCoding is a list of step-by-step instructions that get computers to do what you want them to do. Coding makes it possible for us to create computer software, games, apps and websites. Coders, or programmers, are people who write the programmes behind everything we see and do on a computer.</p>
                </div>
            </div>
